...
from .VGmsdnDataset import VGmsdnRelDataset, VGmsdnLayoutDataset, SNPSingleData
...
def build_loader(cfg, eval_only):
    ...
    return DataLoader(dataset, batch_size, shuffle, validation_split, num_workers), DataLoader(dataset_r, batch_size,
                                                                                               shuffle,
                                                                                               validation_split,
                                                                                               num_workers)
